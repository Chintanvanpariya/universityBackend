...
namespace UniversityServer.Migrations
{
    ...
    [Migration("20210414225435_changedToIDentityServiceAndRoles")]
    partial class changedToIDentityServiceAndRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversityServer.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("UniversityServer.Entities.AppUserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("UniversityServer.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UniversityServer.Entities.AppUserRole", b =>
                {
                    b.HasOne("UniversityServer.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
